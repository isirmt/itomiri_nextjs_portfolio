...
export default function WorkCard({ workContent }: { workContent: WorksContent }) {
  ...
  >
    ...
    <div className="transition-all group-hover:bottom-0 absolute -bottom-14 w-full h-14 bg-red-400 rounded-t-xl flex items-center px-4 text-white text-xl font-bold">
      {workContent.title}
    </div>
  </Link>
}